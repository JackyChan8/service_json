...
class PortfolioV01(Base):
    ...
    dldate: Mapped[str] = mapped_column(DATE)
    ...
    statdate: Mapped[str] = mapped_column(DATE)
    admdate: Mapped[str] = mapped_column(DATE)
    admavdldate: Mapped[str] = mapped_column(DATE)
    ...
    exdate: Mapped[str] = mapped_column(DATE)
